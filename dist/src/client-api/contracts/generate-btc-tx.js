...
const generateCetRedemptionTransaction = async (params) => {
    ...
    if (params.oraclePub2 === undefined) {
        ...
        const twistedPk2 = schnorr.adaptorPublic(params.oraclePub2, params.answer, params.rValue2).padStart(64, "0");
        const twistedPk3 = schnorr.adaptorPublic(params.oraclePub3, params.answer, params.rValue3).padStart(64, "0");
        return (await tx.genAliceCetRedemptionQuorum(params.quorumno, cetOut, twistedPk1, twistedPk2, twistedPk3, params.alicePub, params.bobPub, params.oracleSignature, params.oracleSignature2, params.oracleSignature3, params.amount, params.txfee)).hex;
    }
};
