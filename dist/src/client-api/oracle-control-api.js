...
const defaultPow = {
    powOverOracleId: pow_1.powOverOracleId,
    powOverOracleCapability: pow_1.powOverOracleCapability
};
function oracleControlApi(poolcfg, nodeApi, storage, p2pNode, pow = defaultPow, connections) {
    if (connections === undefined) {
        connections = p2p_1.connectionPool;
    }
    const concfg = {
