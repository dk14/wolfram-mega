...
const startOracleService = (cfg, storage = (0, capability_storage_1.capabilityStorage)(cfg.oracle.dbPath, 1, 100)) => {
    const api = (0, oracle_control_api_1.oracleControlApi)(cfg, api_1.api, storage, p2p_1.p2pNode);
    ...
    wss.on('connection', function connection(ws, req) {
        ...
        if (reqUrl.pathname == '/ranks') {
            ...
            const mutex = new async_mutex_1.Mutex(); // just in case two ads will come concurrently (should not happen)
