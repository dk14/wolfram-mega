...
> *Cryptomagic: Alice chooses random message, e.g. "MAGIC". Alice signs it with some key, but keeps signature private. Alice interprets signature itself literally as private key. Alice derives "repayment wallet" pubkey from this "private key".*
