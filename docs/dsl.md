...
> Since blockchain cannot gurantee receiving payments after deal is settled (Bob simply might not have funds in the future), after maturity alice takes deposit unconditionally.
