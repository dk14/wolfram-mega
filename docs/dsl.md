...
> note: while there is a trivial algorithm to convert inoptimal contract to the optimal one, it cannot be applied in practice. It would not express what YOU meant, your subvocal speechfix, your "self", your personality.
